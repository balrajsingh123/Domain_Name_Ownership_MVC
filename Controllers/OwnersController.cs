...
namespace Domain_Name_Ownership_MVC.Controllers
{
    public class OwnersController : Controller
    {
        ...
        public OwnersController(Domain_Name_Ownership_DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,OwnerName,ContactPhone")] Owner owner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OwnerName,ContactPhone")] Owner owner)
        {
            if (id != owner.Id)
            {
                return NotFound();
